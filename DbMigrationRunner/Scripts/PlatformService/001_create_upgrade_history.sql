...
BEGIN
    ...
    -- Grant permissions to platforms user (changed from productService)
    GRANT USAGE ON SCHEMA upgrade TO platforms;
    GRANT SELECT, INSERT ON upgrade.upgrade_history TO platforms;
    GRANT USAGE, SELECT ON SEQUENCE upgrade.upgrade_history_id_seq TO platforms;
